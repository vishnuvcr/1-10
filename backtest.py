...
def plot_monte_carlo(paths,out,start):
    ...
    ax.axhline(start,ls="--",lw=1,label="Starting equity"); ax.set(xlabel="Completed trades",ylabel="Equity (INR)",title="Monte Carlo Equity Curves — Bootstrap With Replacement"); ax.legend(); ax.grid(alpha=.25)
