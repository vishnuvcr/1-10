...
E008 - Local environment lacks network/yfinance/vectorbt. Repository CI is the integration-validation path.
...
E013 - NIFTY 2010-2026 signal scarcity documented.
E014 - Phase 5 sensitivity runner import path fixed.
E015 - Phase 6 statistical validator failed on zero-byte trades.csv for a no-trade symbol. Fixed by catching pandas EmptyDataError and treating the file as a valid zero-trade case.
